...
EXPORT void onPluginEnable(Ghrum::IPlugin & plugin) {
    plugin.print("Awww Ghrum is enabling me!");
}
...
EXPORT void onPluginDisable(Ghrum::IPlugin & plugin) {
    plugin.print("Awww Ghrum, why are you disabling me?");
}

/**
 * Function called when the plugin has been loaded.
 *
 * @param plugin reference to this plugin
 */
EXPORT void onPluginLoad(Ghrum::IPlugin & plugin) {
    plugin.print("Awww Ghrum found me!!");
}
